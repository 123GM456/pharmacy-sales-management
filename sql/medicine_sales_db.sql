...
INSERT INTO customer (name, sex, phone, address, remark) VALUES
('李伟', 1, '13800138001', '北京市朝阳区建国路 88 号',   '长期客户'),
('王芳', 0, '13900139002', '上海市浦东新区世纪大道 100 号', NULL);

INSERT INTO sale_record
    (medicine_id, customer_id, operator_id, quantity, unit_price, total_amount, sale_time, remark)
VALUES
(1, 1, 2, 5, 12.50, 62.50, '2026-09-01 10:20:00', '现金支付'),
(2, 2, 2, 2,  9.90, 19.80, '2026-09-05 15:40:00', NULL);

-- =============================================================
-- 数据验证（可选，手动取消注释后执行）
-- =============================================================

-- ① 查看所有数据表，确认4张表（sys_user、medicine、customer、sale_record）均已成功创建
-- SHOW TABLES;
